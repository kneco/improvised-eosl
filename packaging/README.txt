...
1. 新しい書き込み可能なフォルダーを作り、そこへZIPファイル全体を展開します。
2. 展開先のルートにある ImprovisedEosl.Spike.SyncModal.exe をダブルクリックします。
...
ZIPの中からEXEを直接開かないでください。EXEに隣接するDLL、config、pages
なども動作に必要です。EXEだけを別の場所へ移動しないでください。
